...
describe('MultiLineChart component', () => {
  ...
  const componentProps = dataExampleSpecs.appComponentStates.multiLineChart;
  ...
  beforeAll((done) => {
    ...
    component = ReactDOM.render(<MultiLineChart {...componentProps} />, element);
    setTimeout(function() {
      done();
  ...
  it('svg displays path for all data values', () => {
    ...
    expect(items.length).toEqual(componentProps.data.series.length);
  });
